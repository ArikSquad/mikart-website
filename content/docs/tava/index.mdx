...
<Callout title="Design rule">
    The logical schema is authoritative. Adapter hints can change how a field is stored, but they should not change what
    the field means in the application model.
</Callout>
